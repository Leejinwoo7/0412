...
const qnaList = [
  {
    q: '1. 외계인이 나타나 다음 중 하나를 죽을 때까지 해야한다고 협박을 합니다. <br> 둘 중 하나를 무조건 해야한다면 차라리 나은 것은?',
    a: [
  ...
  {
    q: '2. 외계인이 나타나 신체의 한 부위를 가져가겠다고 협박을 합니다. 둘 중 어느 쪽을 내어줄까요? ',
    a: [
  ...
  {
    q: '3. ‘맨날 월요일 바이러스’가 퍼진 전세계에 딱 한 집단만 구할 수 있다고 했을 때, 당신은?',
    a: [
  ...
  {
    q: '4. 1억원 어치 주식투자를 하려는 당신, 어느 기업에 투자할 것인가?',
    a: [
      { answer: 'A. 현재까지의 실적이 우수한 안정적인 기업  ', type: ['ISTJ', 'ISTP', 'ISFJ', 'ISFP','ESTJ', 'ESTP', 'ESFJ', 'ESFP'] },
      { answer: 'B. 실적은 다소 부족하지만, 미래의 유망주로 각광을 받는 기업 ', type: ['INTJ', 'INTP', 'INFJ', 'INFP', 'ENTJ', 'ENTP', 'ENFJ', 'ENFP' ] }
    ]
  },

  {
    q: '5. 노트북을 사려는 당신, 우선으로 고려하는 것은?',
    a: [
  ...
  {
    q: '6. 친구에게 제일 좋아하는 영화를 소개할 때 어떻게 말할까?',
    a: [
      { answer: 'A. “이병헌 주연의 느와르 영화야. 인기 많아” 영화를 최대한 객관적으로 전달한다.', type: ['ISTJ', 'ISTP', 'ISFJ', 'ISFP','ESTJ', 'ESTP', 'ESFJ', 'ESFP'] },
      { answer: 'B. “정말 재밌어, 최고야! 이병헌 연기 너무 잘해!” 내가 감동을 느낀 순간을 전달한다.', type: ['INTJ', 'INTP', 'INFJ', 'INFP', 'ENTJ', 'ENTP', 'ENFJ', 'ENFP' ] },
    ]
  },

  {
    q: '7. 직장 상사가 내가 저지른 실수 때문에 크게 화나셨다. 어떻게 풀어드리지?',
    a: [
  ...
  {
    q: '8. 주변인에게 무리한 부탁을 해야한다. 더 싫은 상황은?',
    a: [
  ...
  {
    q: '9. 친구들과 게임을 하는 나. 무슨 생각으로 게임에 임할까 ?',
    a: [
  ...
  {
    q: '10. 도시에 좀비 바이러스가 퍼졌다. 이를 처음 안 나는 어떻게 행동할까?',
    a: [
  ...
  {
    q: '11. 요리대회에 나간 나, 심사위원에게 요리를 어떻게 소개할까?',
    a: [
      { answer: 'A. “그리스에서 수입해온 올리브를 갈아서 ...”  요리를 어떻게 만들었는지 소개한다.', type: ['ISTP', 'ESTP', 'INTP', 'ENTP', 'ESFP', 'ENFP', 'ISFP', 'INFP'] },
      { answer: 'B. “손님들이 부드럽게 음식을 즐길 있게 ...” 강조하고 싶었던 요리의 포인트를 소개한다.', type: ['ISTJ', 'ESTJ', 'INTJ', 'ENTJ', 'ESFJ', 'ENFJ', 'ISFJ', 'INFJ'] },
    ]
  },

  {
    q: '12. 전설의 마법의 약 레시피를 얻은 당신, 레시피대로 했는데 실패했다! 왜지?!',
    a: [
